        ...
        <div class="col-lg-8">
          <div class="hero-content">
            ...
            <p data-aos="fade-up" data-aos-delay="300">
              From residential relocations to commercial moves, we offer complete moving solutions tailored to your specific requirements. Professional, reliable, and efficient service guaranteed.
            </p>
            ...
            <div class="hero-stats" data-aos="fade-up" data-aos-delay="500">
              <div class="row">
                <div class="col-lg-3 col-md-6">
                  <div class="stat-item">
                    <span class="stat-number" data-purecounter-start="0" data-purecounter-end="6" data-purecounter-duration="2">6</span>
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-right" data-aos-delay="200">
        <div class="content">
          <h2 class="section-heading mb-4">Complete Moving Solutions Tailored to You</h2>
          <p class="lead-text mb-4">
            Whether you're moving your home, relocating your business, or transporting specialty items, we provide comprehensive services designed to meet your unique needs.
          </p>
          <p class="description-text mb-5">
            Our experienced team handles every aspect of your move with precision and care. From careful packing and secure loading to safe transportation and organized unpacking, we ensure a seamless relocation experience. With modern equipment, trained professionals, and a commitment to excellence, we deliver peace of mind at every step.
          </p>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-item" data-aos="fade-up" data-aos-delay="350">
              ...
              <div class="stat-label">Insured Moves</div>
            </div>
      ...
      <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="200">
        <div class="image-section">
          <div class="main-image">
            <img src="assets/img/construction/project-4.webp" alt="Moving services" class="img-fluid">
          </div>
          <div class="floating-badge" data-aos="zoom-in" data-aos-delay="500">
            <div class="badge-content">
              <i class="bi bi-award"></i>
              <div class="badge-text">
                <span class="badge-title">Professional Service</span>
...
<section id="services" class="services section light-background">
  ...
  <div class="container section-title" data-aos="fade-up">
    ...
    <p>Professional relocation solutions for homes, businesses, and specialty items</p>
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <section id="team" class="team section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>How we ensure a smooth and stress-free moving experience</p>
      </div><!-- End Section Title -->
